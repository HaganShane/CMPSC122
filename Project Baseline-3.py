...
### Get and Set Functions ###
    ...
    def to_string(self):
        return "Title: {0}, ISBN: {1}, Author: {2}, Publisher: {3}, Date Added: {4}, Quantity On Hand: {5}, Wholesale Cost: {6}, Retail Cost: {7}".format(self.__title, self.__isbn, self.__author, self.__publisher, self.__date, self.__qty, self.__wholesale, self.__retail)
...
def bookInfo(book):
    ...
    print("Title: " + book.__title)
    print("ISBN: " + book.__isbn)
    print("Author: " + book.__author)
    print("Publisher: " + book.__publisher)
    print("Date Added: " + book.__date)
    print("Quantity-On-Hand: " + str(book.__qty))
    print("Wholesale Cost: %.2f" % float(book.__wholesale))
    print("Retail Price: %.2f" % float(book.__retail))
    print("\n\n")
        ...
        if userchoice in titleNumbers:
            ...
            while choice != 9:
                ...
                if choice == 1:
                    ...
                    info.SetTitle = str.upper(input( "Enter new Title:  "))
                elif choice == 2:
                    print( "\nCurrent ISBN: " + book.GetIsbn)
                    info.SetIsbn = str.upper(input( "Enter new ISBN(#-###-#####-#): "))
                elif choice == 3:
                    print( "\nCurrent Author: " + book.GetAuthor)
                    info.SetAuthor = str.upper(input("Enter new Author: "))
                elif choice == 4:
                    print( "\nCurrent Publisher: " + book.GetPublisher)
                    info.SetPublisher = str.upper(input( "Enter new Publisher:  "))
                elif choice == 5:
                    print( "\nCurrent Date Added: " + book.GetDate)
                    info.SetDate = input( "Enter new Date(MM/DD/YYYY):  ")
                elif choice == 6:
                    print( "\nCurrent Quantity on Hand:  " + str(book.GetQty))
                    try:
                        info.SetQty = int(input( "Enter new Quantity on Hand:  "))
                    except:
                        print("\nError: You must enter a valid quantity.\n")
                elif choice == 7:
                    print( "\nCurrent Wholesale Cost:  " + str(book.GetWholesale))
                    info.SetWholesale = float(input( "Enter new Wholesale Cost:  "))
                elif choice == 8:
                    print( "\nCurrent Retail Price:  " + str(book.GetRetail))
                    info.SetRetail = float(input( "Enter new Retail Price:  "))
...
def repWholesale():
    ...
    for book in bookData:
        ...
        TotalWholesale += float(book.qty) * float(book.wholesale)
        a += 1
        b += 1
...
def repRetail():
    ...
    for book in bookData:
        ...
        TotalRetail += float(book.qty) * float(book.retail)
        a += 1
        b += 1
...
def GetBooks():
    try:
        ...
        for line in f:
            ...
            bookData.append(BookData(LineSplit[0], str(LineSplit[1]), LineSplit[2], LineSplit[3], LineSplit[4], float(LineSplit[5]), float(LineSplit[6]), float(LineSplit[7])))
